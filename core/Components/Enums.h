...
struct Enums {
    static void refl();
    static std::vector<std::pair<std::string, int>> enums;
    static void AddEnum(const std::string& enumName, int val);
    ...
    static const int KEY_APP1;
    static const int KEY_APP2;

    static const int KEY_AUDIOREWIND;
    static const int KEY_AUDIOFASTFORWARD;

    static const int STATIC_BODY;
    static const int KINEMATIC_BODY;
    static const int DYNAMIC_BODY;

    static const int RENDER_SOLID;
    static const int RENDER_SHARED;
    static const int RENDER_LCD;
    static const int RENDER_BLENDED;

    static const int ALIGN_LEFT;
    static const int ALIGN_MIDDLE;
    static const int ALIGN_RIGHT;

    static const int WINDOW_NORMAL;
    static const int WINDOW_MAXIMIZED;
    static const int WINDOW_FULL;
    static const int WINDOW_FULL_DESK;
};
